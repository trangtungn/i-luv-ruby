...
class SortConcreteStrategy < Strategy
  # @param [Array] data
  #
  # @return [Array]
...
class ReverseConcreteStrategy < Strategy
  # @param [Array] data
  #
  # @return [Array]
  def do_algorithm(data)
